...
function getTableHeaderElement(): string {
    const headerElement = [
        ...
        `<div class="qr-name-wrap"><span class="table__header-element qr-name" data-az="za" ></span>
        ...
        `<div class="qr-type-wrap"><span class="table__header-element qr-type" data-az="za"></span>
        <span class="sort-arrow">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <symbol id="btn-sort2">
                    <path d="M11.8079 18.7695L8.09346 14.3121C7.65924 13.7911 8.02976 13 8.70803 13L15.292 13C15.9702 13 16.3408 13.7911 15.9065 14.3121L12.1921 18.7695C12.0921 18.8895 11.9079 18.8895 11.8079 18.7695Z" fill="var(--color-up, #B6C4D8)"></path>
        ...
        '<span class="table__header-element insert-btn"><button class="table__header-del-btn" disabled></span>',
    ];
